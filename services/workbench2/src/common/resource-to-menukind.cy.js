    ...
    describe('resourceToMenuKind', () => {
        ...
        it('should return the correct menu kind', () => {
            const cases = [
                ...
                [headCollectionUuid, false, false, true, false, ContextMenuKind.TRASHED_COLLECTION],
                ...
                [oldCollectionUuid, false, true, true, false, ContextMenuKind.TRASHED_COLLECTION],
                [oldCollectionUuid, false, true, false, false, ContextMenuKind.OLD_VERSION_COLLECTION],
                [oldCollectionUuid, false, false, true, false, ContextMenuKind.TRASHED_COLLECTION],
                [oldCollectionUuid, false, false, false, false, ContextMenuKind.OLD_VERSION_COLLECTION],
                [oldCollectionUuid, true, true, true, false, ContextMenuKind.TRASHED_COLLECTION],
                [oldCollectionUuid, true, true, false, false, ContextMenuKind.OLD_VERSION_COLLECTION],
                [oldCollectionUuid, true, false, true, false, ContextMenuKind.TRASHED_COLLECTION],
                ...
                [projectUuid, false, false, true, false, ContextMenuKind.TRASHED_PROJECT],
