...
export enum ContextMenuKind {
    ...
    TRASHED_PROJECT = "TrashedProject",
    TRASHED_WORKFLOW = "TrashedWorkflow",
    TRASHED_COLLECTION_FILES = "TrashedCollectionFiles",
    TRASHED_COLLECTION_FILES_MULTIPLE = "TrashedCollectionFilesMultiple",
    TRASHED_COLLECTION_FILE_ITEM = "TrashedCollectionFileItem",
    TRASHED_COLLECTION_DIRECTORY_ITEM = "TrashedCollectionDirectoryItem",
    USER = "User",
